    ...
    render() {
        return (
            <InstructionsPage
                ...
                continuePrompt={
                    "Click in this box to try some practice problems."
                }
                paragraphs={[
                    <span>
                        During the feedback, you will see a number in{" "}
                        <span style={{ color: "red" }}>RED</span> in the top
                        right of the screen.
                    </span>,
                    <span>
                        This indicates your percent correct for the sentence
                        problems for the entire experiment.
                    </span>,
                    <span>
                        For our purposes, we can only use data where the
                        participant was
                        <b> AT LEAST 85%</b> accurate on the sentences.
                    </span>,
                    <span>
                        Therefore, try to perform <b> AT LEAST 85%</b> on the
                        sentence problems while doing your best to recall AS
