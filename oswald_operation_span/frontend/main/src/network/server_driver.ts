...
const BASE_URL = "/digital-deception/ospan";
...
export default class ServerDriver extends JSONAPIDriver {
    uploadTestResult(subjectId: string, experimentVersion: string, timestamp: Date, letterResult: LetterResult, sentenceResult: MathResult): Promise<Response> {
